        ...
        items: [{
            ...
            episodes: {
                items: [{
                    ...
                    video: 'https://aaposters.s3.ap-south-1.amazonaws.com/www.3MovieRulz.sx+-+Ala+Vaikunthapurramuloo+(2020)+v2+720p+Telugu+Proper+HDRip+x265+HEVC+DD5.1+-+900MB+ESub.mkv',
                }]
            }
        }, {
            id: 'season2',
